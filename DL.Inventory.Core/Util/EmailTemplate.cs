       ...
       public static string ResetPassword(string username, string password)
        ...
        public static string NewUser(string username, string password)
        {
            ...
            <body>
                ...
                <div style = 'background-color:blueviolet'>
                        </br><h2 style = 'color: cornsilk; margin-left: 10px;'>Bem vindo(a) " + username + @"</h2></br></br>         
                        <h3 style = 'color: cornsilk; margin-left: 10px;'>Voc&ecirc; está cadastrado em nosso sistema.</h3>              
                        <h3 style = 'color: cornsilk; margin-left: 10px;'>Abaixo sua senha para acesso:</h3>                     
                        <h3 style = 'color: cornsilk; margin-left: 10px;'><strong>" + password + @"</strong></h3></br></br></br>             
                        <h3 style = 'color: cornsilk; margin-left: 10px;'>Obrigado!</h3></br>                             
                </div>
                <div style = 'text-align: center; margin-bottom: 9px; color: blueviolet;'>                              
